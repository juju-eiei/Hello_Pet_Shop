...
c = Object.assign('', c.split(/function renderCustomers\(data\) \{[\s\S]*?\}\n\n\s*document\.getElementById\('searchInput'\)/)[0] + 
           newRender.trim() + 
           '\\n\\n        document.getElementById(\\'searchInput\\')' + 
           c.split(/function renderCustomers\(data\) \{[\s\S]*?\}\n\n\s*document\.getElementById\('searchInput'\)/)[1]);
